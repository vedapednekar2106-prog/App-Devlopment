  ...
  void _buttonPressed(String value) async {
    if (value == '=') {
      try {
        ...
        await dbHelper.insertCalculation(input, evalResult);
        debugPrint("✅ Saved to SQLite: $input = $result"); // 👈 added here
      } catch (e) {
        setState(() {
          result = 'Error';
        });
            ...
            Expanded(
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(input, style: const TextStyle(fontSize: 32, color: Colors.white70)),
